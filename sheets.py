...
def export_to_sheets(data: Dict[str, Any]) -> bool:
    ...
    9. Дата початку
    10. Дата кінця
    11. Населений пункт завантаження
    12. Склад завантаження
    13. Спосіб завантаження
    14. Контакт на завантаженні
    15. Номер телефона на завантаженні
    16. Населений пункт розвантаження
    17. Склад розвантаження
    18. Спосіб розвантаження
    19. Контакт на розвантаженні
    20. Номер телефона на розвантаженні
    """
    try:
        ...
        row = [
            ...
            data.get("cargo_type", "—"),                 # 5. Вид вантажу
            ...
            load_name,                                   # 14. Контакт на завантаженні
            load_phone,                                  # 15. Номер телефона на завантаженні
            data.get("unload_city", "—"),                # 16. Населений пункт розвантаження
            data.get("unload_place", "—"),               # 17. Склад розвантаження
            data.get("unload_method", "—"),              # 18. Спосіб розвантаження
            unload_name,                                 # 19. Контакт на розвантаженні
            unload_phone,                                # 20. Номер телефона на розвантаженні
        ]
